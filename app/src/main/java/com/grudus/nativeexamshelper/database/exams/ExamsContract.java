...
public class ExamsContract {
    ...
    public static abstract class OldExamEntry implements BaseColumns {
        ...
        public static final String[] ALL_COLUMNS = {_ID, SUBJECT_COLUMN, INFO_COLUMN, DATE_COLUMN, GRADE_COLUMN, CHANGE_COLUMN};
    ...
    public static abstract class ExamEntry implements BaseColumns {
        ...
        public static final String[] ALL_COLUMNS = {_ID, SUBJECT_COLUMN, INFO_COLUMN, DATE_COLUMN, CHANGE_COLUMN};
